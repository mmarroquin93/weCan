...
<body data-offset="200" data-spy="scroll" data-target=".ow-navigation">
	...
	<div class="main-container">
		...
		<!-- Product List -->
		<div class="product-list container-fluid no-padding">
			...
			<div class="container">
				<div class="row">
					...
					<!-- Product Details --> 
					<!-- col-md-9 -->
					<div class="col-md-9 col-sm-8 single-product-detail">
						<div class="row">
							<div class="col-md-5 col-sm-5 single-product">						
								<img src="images\shop\single-product.jpg" alt="single-product">
							</div>
							<div class="col-md-7 col-sm-7 summary">
								<div class="entry-summary">
									<h2 class="product_title">Neck Harness with Bell</h2>
									<p class="price"><span class="amount">$75</span><del>$85</del></p>
									<div class="review-link">
										<a href="#" title="Reviews">5 Review(s)</a>
										<a href="#" title="Add Review">Add Your Review</a>
									</div>
									...
									<div class="color-option">
										<h5>Color :</h5>
										<div class="color-box"><span></span></div>
										<div class="color-box color2"><span></span></div>
										<div class="color-box color3"><span></span></div>
										<div class="color-box color4"><span></span></div>
										<div class="color-box color5"><span></span></div>
										<div class="color-box color6"><span></span></div>
									</div>
									<div class="add-icons">
										<a href="#" title="Wishlist"><img src="images\icon\addto-1.png" alt="addto-icon"></a>
										<a href="#" title="Share"><img src="images\icon\addto-2.png" alt="addto-icon"></a>
										<a href="#" title="Email"><img src="images\icon\addto-3.png" alt="addto-icon"></a>
									</div>
									<div class="qty-add">
										<div class="quantity">
											<label>Qty :</label>
										...
										<div class="add-to-cart">
											<a title="Add To Cart" href="#" class="btn"><img src="images\icon\addto-cart.png" alt="Add to cart">Add To Cart</a>	
										</div>
									</div>
									<div class="product-stock">
										<span>Availability : </span>
										<a title="In Stock" href="#">In Stock 20 Item(s)</a>
									</div>
								</div>
							</div>
							
							<div class="woocommerce-tabs col-md-12 col-sm-12 col-xs-12">
								<div role="tabpanel">
									<!-- Nav tabs -->
									<ul class="nav nav-tabs" role="tablist">
										<li role="presentation" class="active"><a title="Product Details" href="#product-details" role="tab" data-toggle="tab">Product deTails</a></li>
										<li role="presentation"><a title="Review" href="#review" role="tab" data-toggle="tab">reviews</a></li>
										<li role="presentation"><a title="Product Tags" href="#product-tags" role="tab" data-toggle="tab">product tags</a></li>
									</ul>
									<!-- Tab panes -->
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane active" id="product-details">
											<p>Then along come two they got nothin' but their jeans. Flying away on a wing and a prayer. Who could it be? Believe it or not its just me. Today still wanted by the government they survive as soldiers of fortune. Boy the way Glen Miller played. Songs that made the hit parade. Guys like us we had it made. Those were the days.</p>
										</div>
							...
							<!-- Product List -->
							<div id="product-list" class="product-list col-md-12 col-sm-12 col-xs-12">
